...
DATABASE = {
    ...
    "USER": os.environ.get("DB_USER", "netbox"),  # PostgreSQL username
    "PASSWORD": os.environ.get("DB_PASSWORD", "FxHZsQCr6s3qj6EK"),
    # PostgreSQL password
...
#SECRET_KEY = os.environ.get("SECRET_KEY", "evhLQDsYsMLFQxZMw82jnHt3UYf86FppfdHW")

SECRET_KEY = 'iv5GhMzkaoUylzAM!Vq)LQBn5ZKVWTqkTBYt@K798H_Qd726=='
...
REDIS = {
    "caching": {
        ...
        "PASSWORD": os.environ.get("REDIS_PASSWORD", "FxHZsQCr6s3qj6EK"),
        "DATABASE": 1,
